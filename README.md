...
　※このリポジトリに同梱しているモデルは、発表資料の載せた動画よりも検出性能が低いです<br>
ライセンス：[Apache-2.0](LICENSE(Apache-2.0))<br>
...
ソースコード：[04_pose_estimation/demo_onnx.py](https://github.com/Kazuhito00/PyCon-mini-Shizuoka-2021/blob/main/04_pose_estimation/demo_onnx.py)<br>
